  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        ...
        {/* Features Section */}
        <section id="features" className="w-full py-12 md:py-24 bg-[#030305]">
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3">
              ...
              <EnhancedCard
                title="GPU Computing"
                description="High-performance GPU resources for AI, rendering, and compute workloads."
                icon={Gpu}
