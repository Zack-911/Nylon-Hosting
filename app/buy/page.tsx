        ...
        <section className="w-full py-12 md:py-24 lg:py-32 relative overflow-hidden">
          <div className="container relative z-10 px-4 md:px-6">
            <div className="flex flex-col items-center text-center space-y-4 max-w-3xl mx-auto">
              <Badge className="bg-purple-500/10 text-purple-400 border-purple-500/20">NexusHost Marketplace</Badge>
        ...
        <section className="w-full py-12 md:py-24 bg-[#030305]">
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              {/* GPU Computing */}
              <Link href="/buy/gpu" className="block">
                <Card className={`bg-[var(--bg-card)] border-slate-800 h-full ${styles.cardHover}`}>
                  <div className="relative h-48 overflow-hidden rounded-t-lg">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex items-end p-6">
                      <h3 className="text-2xl font-bold text-white">GPU Computing</h3>
                    </div>
                  </div>
                  <CardContent className="p-6 text-slate-300 flex-grow">
                    <p>
                      Access high-performance GPUs for AI, machine learning, rendering, and compute-intensive workloads.
                    </p>
